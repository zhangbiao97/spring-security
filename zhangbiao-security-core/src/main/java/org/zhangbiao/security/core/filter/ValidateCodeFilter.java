...
import org.zhangbiao.security.core.validate.code.ValidateCodeProcessorHolder;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (type != null) {
            ...
            try {
                ...
                authenticationFailureHandleCustomize.onAuthenticationFailure(request, response, exception);
                return;
            } catch (Exception e) {
                e.printStackTrace();
            }
